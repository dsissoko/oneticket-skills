---
name: oneticket-working-effectively-with-legacy-code
description: "Safe patterns for modifying existing code without breaking contracts — use when fixing, updating, or refactoring existing files. Covers seams, characterization tests, dependency breaking, and incremental change."
version: 1.0.0
source: "ciembor/agent-rules-books (MIT) — adapted from Working Effectively with Legacy Code by Michael Feathers"
---
