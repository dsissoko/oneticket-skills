...
Possible domains include software delivery, scientific research, recipe discovery, investment research, legal analysis, or other knowledge-intensive processes. Each specialization may introduce its own entities, relations, states, transitions, guards, and actions while retaining the generic knowledge concepts where useful.
